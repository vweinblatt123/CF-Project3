...
from asset_allocation import mean_variance, monte_carlo
...
with BlackLitterman:
    ...
    q_list1, p_list1, c_list1 = build_P(B1,B2,B3,B4,B5)
    ...
    q_list2, p_list2, c_list2 = build_P(B1,B2,B3,B4,B5)
    ...
    q_list3, p_list3, c_list3 = build_P(B1,B2,B3,B4,B5)
    ...
    q_list4, p_list4, c_list4 = build_P(B1,B2,B3,B4,B5)
    ...
    q_list5, p_list5, c_list5 = build_P(B1,B2,B3,B4,B5)
